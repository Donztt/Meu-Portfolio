            ...
            <div className="footer-basic">
                <footer>
                    <div className="social">
                        ...
                        <a href="https://www.instagram.com/doni.oliveirajr"><i className="fa fa-instagram"></i></a>
                        <a href="https://open.spotify.com/playlist/7nef82IFyJX9yBjzYwrdc5?si=86902617a00c4dff"><i className="fa fa-spotify"></i></a>
                    </div>
                        ...
                        <div className="container">
                            <div className="row align-items-start">
                                ...
                                <div className="col">
                                    ...
                                    <p><a href={PtCurriculo} download>{TRANSLATION.FOOTER.CURRICULUM} - (PT-BR)</a></p>
                                    <p><a href={EnCurriculo} download>{TRANSLATION.FOOTER.CURRICULUM} - (EN)</a></p>
                                </div>
                                <div className="col">
